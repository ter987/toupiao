...
.vote{background: rgb(61, 156, 237);}
.zhanshi .vote a{background: rgb(61, 156, 237);}
.loadmore .more a{background: rgb(61, 156, 237);}
</style>
...
<hr class="xt">
    <dl id="tab">
	<dd class="current"  style=" background:url(images/nav_bg1.png) no-repeat #269bf6;"><?php if($vote['zdyname'] != ''): echo ($vote["zdyname"]); else: ?>参赛选手<?php endif; ?></dd>
    <dd style="background:url(images/nav_bg2.png) no-repeat #269bf6;">活动介绍</dd>
    <dd style="background:url(images/nav_bg3.png) no-repeat #269bf6;">活动奖品</dd>
    </dl>
    <div id="content">
    ...
    <button type="submit" title="搜索" class="button"><span><span>搜索</span></span></button>
		...
		<ul class="cc">
			...
			<p class="vote"><a href="<?php echo C('site_url');?>/index.php?g=Wap&m=Vote&a=show&token=<?php echo ($token); ?>&id=<?php echo ($li["id"]); ?>&wecha_id=<?php echo ($wecha_id); ?>&tid=<?php echo ($id); ?>" style="background: rgb(61, 156, 237);">详细资料</a></p></li><?php endforeach; endif; else: echo "" ;endif; ?>
		  </ul>
		</div>
...
﻿
     <div style="width:100%;height:50px;position:fixed;bottom:0;background:rgb(61, 156, 237);font-family:'Microsoft YaHei';color:#fff;z-index:1000;left: 0;">
        <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left: 1px solid rgb(86, 196, 239);border-right: 1px solid #1A67BD;"><a style="color:#fff;" href="<?php echo U('Vote/index',array('token'=>$_GET['token'],'tid'=>$_GET['tid']));?>"><dt><img width="28" height="28" src="images/shouye.png" /></dt><dd>首 页</dd></a></dl>
         <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left: 1px solid rgb(86, 196, 239);border-right: 1px solid #1A67BD;"><a style="color:#fff;" href="<?php echo U('User/Bm/wap',array('token'=>$_GET['token'],'tid'=>$_GET['tid']));?>"><dt><img width="28" height="28" src="images/baoming.png" /></dt><dd>我要报名</dd></a></dl>
         <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left: 1px solid rgb(86, 196, 239);border-right: 1px solid #1A67BD;"><a style="color:#fff;" href="<?php echo U('Vote/share',array('token'=>$_GET['token'],'tid'=>$_GET['tid']));?>"><dt><img width="28" height="28" src="images/paihang.png" /></dt><dd>排行榜</dd></a></dl>
         <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left: 1px solid rgb(86, 196, 239);border-right: 1px solid #1A67BD;"><a style="color:#fff;" href="<?php echo ($info["email"]); ?>"><dt><img width="28" height="28" src="images/guanzhu.png" /></dt><dd>关注我们</dd></a></dl>
     </div>

<div id="gz_footer">版权所有 Copyright 2015 <?php echo ($info["gongzhong"]); ?> <script language=javascript>
