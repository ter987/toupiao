	...
	<div class="main_wrap">
		...
		<div class="zhanshib">
           ...
           <div class="cl"></div>
            ...
            <div class="cl"></div>
            <div class="xuanyan">参赛宣言：<?php  echo html_entity_decode(htmlspecialchars_decode($data['intro']));?></div>
<!--			<ul class="cc">
		...
		<h3 style="background:#2ebbc5;">活动介绍</h3>
    ...
    <div class="tanchuang" style="position:fixed;width:85%;height:30%;background:#fff;left:10%;top:30%;font-size:16px;box-shadow:0 0 8px #aaa;">
      <div class="tc_1" style="width:100%;height:24%;background:#fe785a;color:#fff;text-align:center;line-height:37px;float:left;position:relative;">请关注公众号后投票<span class="guanbi" style="width:15%;height:100%;display:block;cursor:pointer;text-align:center;line-height:37px;float:right;background:#fcf9b5;font-size:18px;color:#fe785a;">X</span></div>
        <div class="tc_2"style="width:100%;height:40%;background:#fff;color:#000;text-align:center;border-bottom:1px dashed #eee;font-size:14px;float:left;position:relative;padding-top:12px;">请关注公众号“<span style="color:#fe785a"><?php echo ($gzh["gongzhong"]); ?></span>”<br />直接在公众号内回复：<span style="color:#fe785a"><?php echo ($data["id"]); ?></span></div>
      ...
      <div class="tc_1" style="width:100%;height:24%;background:#fe785a;color:#fff;text-align:center;line-height:37px;float:left;position:relative;">请关注公众号后报名<span class="guanbi" style="width:15%;height:100%;display:block;cursor:pointer;text-align:center;line-height:37px;float:right;background:#fcf9b5;font-size:18px;color:#fe785a;">X</span></div>
        <div class="tc_2"style="width:100%;height:45%;background:#fff;color:#000;text-align:center;border-bottom:1px dashed #eee;font-size:14px;float:left;position:relative;padding-top:5px;">关注公众号“<span style="color:#fe785a"><?php echo ($gzh["gongzhong"]); ?></span>”<br />直接点击自定义菜单的“我要报名”<br />或者在公众号内回复：<span style="color:#fe785a">报名</span></div>
        <div class="tc_3" style="width:100%;height:27%;background:#fff;color:#000;text-align:center;text-align:center;float:left;position:relative;"><a style="width:40%;height:80%;background:#2ebbc5;color:#fff;text-align:center;display:block;margin:2px auto;line-height:26px;" href="<?php echo ($gzh["email"]); ?>">一键关注</a></div>
    </div>
...
<div id="gz_footer">版权所有 Copyright 2015 <?php echo ($gzh["tel"]); ?>
...
<script type="text/javascript">function lp(){
	//document.getElementById('mcover').style.display='block';
        ...
        <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left:1px solid #fe685e;border-right:1px solid #fa4034;"><a style="color:#fff;" href="<?php echo U('Vote/index',array('token'=>$token,'id'=>$id));?>"><dt><img width="28" height="28" src="images/shouye.png" /></dt><dd>首 页</dd></a></dl>
         <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left:1px solid #fe685e;border-right:1px solid #fa4034;"><a style="color:#fff;" href="<?php echo U('Vote/index',array('token'=>$token,'id'=>$id));?>"><dt><img width="28" height="28" src="images/saishi.png" /></dt><dd>参赛说明</dd></a></dl>
         <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left:1px solid #fe685e;border-right:1px solid #fa4034;"><a style="color:#fff;" href="<?php echo U('Vote/share',array('token'=>$token,'id'=>$tid,'g'=>'user'));?>"><dt><img width="28" height="28" src="images/paihang.png" /></dt><dd>排行榜</dd></a></dl>
         <dl style="width:24.2%;height:48px;padding-top:2px;text-align:center;float:left;border-left:1px solid #fe685e;border-right:1px solid #fa4034;"><a style="color:#fff;"href="<?php echo ($gzh["email"]); ?>"><dt><img width="28" height="28" src="images/guanzhu.png" /></dt><dd>关注我们</dd></a></dl>
     </div>
