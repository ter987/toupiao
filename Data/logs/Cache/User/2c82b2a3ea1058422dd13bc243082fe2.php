...
<link href="<?php echo RES;?>/css/style.css?id=100" rel="stylesheet" type="text/css" />
          <div class="cLineB"><h4>信息绑定</h4><a href="<?php echo U('User/Vote/index');?>" class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回</a></div>
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>
				<tr>
                	...
                	<td><input type="text" class="px"  value="<?php echo ($info['tel']); ?>" name="tel">　请输入您的网站名称</td>
                </tr>
				<tr>
				...
				<tr>
                	<th>&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>二维码图片</th>
				...
				<tr>
                	...
                	<td><input type="text" class="px"  value="<?php echo ($rep['content']); ?>" name="content">　关注您的公众账号后回复的内容</td>
                </tr>
				<tr>
                	<th>&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>关注地址</th>
                	<td><input type="text" class="px"  value="<?php echo ($info['email']); ?>" name="email">　请输入您的公众号关注链接</td>
                </tr>
                 <tr>
                 	<th></th>
                 	<td><button type="submit" name="button" class="btn btn-primary btn_submit  J_ajax_submit_btn">确定</button></td>
                 	</tr>
              </tbody>
            </table>
